data "template_file" "tf_ecs_task_template_ms2" {
...
resource "aws_ecs_task_definition" "tf_ecs_task_definition_ms2" {
  family                   = "${var.project_name}-${var.microservices_name}-${var.project_environment}-family"
  container_definitions    = "${data.template_file.tf_ecs_task_template_ms2.rendered}"
